...
class PieceSpek : Spek({
    describe("Piece helper functions") {
        ...
        it("removes the last tile if the color is the same") {
            ...
            val whitePieceOnTile = removeFinalIfColorSame(whitePiece, board, tiles + whitePiece.tile)
            val blackPieceOnTile = removeFinalIfColorSame(blackPiece, board, tiles + whitePiece.tile)
